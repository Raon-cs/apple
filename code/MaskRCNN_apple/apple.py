...
수정인 : 광주인공지능사관학교 - 팀 리미트리스


1. revised 'balloon.py' of Mask R-CNN to 'apple.py'

- changed the word 'balloon' to 'apple'
- changed the [number of classes]
- added codes for ignoring warnings (using 'filterwarnings')


2. AiHub의 "전북 장수 사과 당도 품질 데이터" 소스 코드를 참고하였습니다
